...
g++ -ggdb -std=c++20 -o build/dac-pm-add src/c/dac-pm-add.cpp $( pkg-config --libs sqlite3 ) iso-8601-duration-mock.o build/TicketFromVim.o build/DescriptionGrabber.o build/StdinWithUngetStreambuf.o
